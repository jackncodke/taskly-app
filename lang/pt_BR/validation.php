...
return [
    ...
    | validação. Algumas regras possuem várias versões, como as de tamanho:
    | sinta-se à vontade para ajustar cada uma delas.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aqui é possível definir mensagens personalizadas por atributo e regra,
    | usando a convenção "atributo.regra" para nomear as linhas.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir trocam o marcador :attribute por um nome mais
    | amigável, como "endereço de e-mail" no lugar de "email".
    |
    */
